...
$string['settings:coursecategorydesc'] = '<h3 dir="ltr" style="text-align: left;"><strong>NO NOT MODIFY OR DELETE!</strong></h3><p dir="ltr" style="text-align: left;">This category is used for data synchronization with your <em>iScholar</em>.</p><p dir="ltr" style="text-align: left;">Changing or removing this category may cause the integration with your <em>iScholar</em> to malfunction.</p>';
...
$string['config:coursecategory'] = 'Category for data synchronization.';
...
$string['configerror:timezone'] = 'Check and adjust the time zone settings as described in this <a target="_blank" href="">help page</a>.';
